...
/* return Object.keys(objeto).map((jey) => { 
...
function numberOfCharacters(string) {
  ...
  for (var i = 0; i < string.length; i++) {
    ...
    } else {cantCaracteres[string[i]] = 1; }
  }
...
function capicua(numero){
  ...
  /*var textt = numero.toString();
    var palabraInvertida = '';
    for(var i = textt.length - 1; i>=0; i--) {
      palabraInvertida += textt[i];
    }
    if (numero == palabraInvertida) { return "Es capicua"} else { return "No es capicua"}; */
}
